    ...
    <div>
      <div className="flex gap-3 px-2.5 py-2.5 justify-between w-full bg-slate-100 my-2">
        ...
        <div className="flex gap-3">
          <p
            className={`p-2 rounded font-medium text-xs my-auto ${
              task?.status === "pending"
          ...
          <p
            ...
            } p-2 rounded text-white text-xs my-auto`}
          >
            {task?.priority}
          </p>
          <p className="bg-yellow-200 p-2 text-xs my-auto">
            {transformDate(task?.dueDate)}
          </p>
          <Icons
            handleClick={() => {
